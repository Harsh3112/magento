...
class Hp_Banner_Block_Adminhtml_Banner_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
   ...
   protected function _prepareCollection()
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('image', array(
            ...
            'align'     => 'left',
            'index'     => 'image',
            'renderer'  => 'Hp_Banner_Block_Adminhtml_Banner_Grid_Renderer_Image'
        ));
        ...
        $this->addColumn('status', array(
            ...
            'align'     => 'left',
            'index'     => 'status',
            'renderer' => 'Hp_Banner_Block_Adminhtml_Banner_Grid_Renderer_Status',
        ));
