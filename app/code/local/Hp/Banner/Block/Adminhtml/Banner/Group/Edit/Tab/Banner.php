...
class Hp_Banner_Block_Adminhtml_Banner_Group_Edit_Tab_Banner extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    {
        $result = array(
            'gallery'  => Mage::getConfig()->getBlockClassName('banner/adminhtml_banner_group_edit_tab_form_gallery'),
