...
class Hp_Banner_Block_Adminhtml_Banner_Group_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
   ...
   protected function _prepareCollection()
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('group_key', array(
            ...
            'align'     => 'left',
            'index'     => 'group_key',
            // 'renderer'  => 'Vishal_Brand_Block_Adminhtml_Brand_Grid_Renderer_Image'
        ));
