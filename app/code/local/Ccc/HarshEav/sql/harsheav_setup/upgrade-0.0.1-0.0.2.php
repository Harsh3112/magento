...
$table = $installer->getConnection()
		->newTable($installer->getTable('harsheav/eav_attribute'))
    ...
    ->addIndex($installer->getIdxName('harsheav/eav_attribute', array('used_for_sort_by')),
        array('used_for_sort_by'))
    ->addIndex($installer->getIdxName('harsheav/eav_attribute', array('used_in_product_listing')),
        array('used_in_product_listing'))
    ->addForeignKey($installer->getFkName('harsheav/eav_attribute', 'attribute_id', 'eav/attribute', 'attribute_id'),
        'attribute_id', $installer->getTable('eav/attribute'), 'attribute_id',
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
    ->setComment('HarshEav EAV Attribute Table');

    $query = "ALTER TABLE `harsheav_varchar` ADD UNIQUE( `attribute_id`, `store_id`, `entity_id`)";
...
$setup->addAttribute(Ccc_HarshEav_Model_Resource_HarshEav::ENTITY, 'firstname', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'firstname',
    ...
    'global'                     => Ccc_HarshEav_Model_Resource_Eav_Attribute::SCOPE_STORE,

));

$setup->addAttribute(Ccc_HarshEav_Model_Resource_HarshEav::ENTITY, 'lastname', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'lastname',
...
$setup->addAttribute(Ccc_HarshEav_Model_Resource_HarshEav::ENTITY, 'email', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'email',
...
$setup->addAttribute(Ccc_HarshEav_Model_Resource_HarshEav::ENTITY, 'phoneNo', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'phoneNo',
