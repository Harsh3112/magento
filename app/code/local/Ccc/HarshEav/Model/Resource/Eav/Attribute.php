<?php
class Ccc_HarshEav_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    const SCOPE_STORE                           = 0;
    const SCOPE_GLOBAL                          = 1;
    const SCOPE_WEBSITE                         = 2;
    const MODULE_NAME                           = 'Ccc_HarshEav';
    const ENTITY                                = 'HarshEav_eav_attribute';
    ...
    public static function initLabels($storeId = null)
    {
        if (is_null(self::$_labels)) {
            ...
            $attributes = Mage::getResourceSingleton('harsheavattribute/harsheavattribute')->getAttributesByCode();
