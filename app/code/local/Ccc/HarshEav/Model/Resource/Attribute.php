...
class Ccc_HarshEav_Model_Resource_Attribute extends Mage_Eav_Model_Resource_Entity_Attribute
{
    ...
    protected function _clearUselessAttributeValues(Mage_Core_Model_Abstract $object)
    {
        ...
        if ($object->isScopeGlobal()
            ...
            && Ccc_HarshEav_Model_Resource_Eav_Attribute::SCOPE_GLOBAL != $origData['is_global']
        ) {
