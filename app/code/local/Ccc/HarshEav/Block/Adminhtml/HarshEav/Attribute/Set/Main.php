...
class Ccc_HarshEav_Block_Adminhtml_HarshEav_Attribute_Set_Main extends Mage_Adminhtml_Block_Template
{
    
    protected function _construct()
    {
        $this->setTemplate('harsheav/attribute/set/main.phtml');
    }
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild('group_tree',
            $this->getLayout()->createBlock('harsheav/adminhtml_harsheav_attribute_set_main_tree_group')
        );
        ...
        $this->setChild('delete_group_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('harsheav')->__('Delete Selected Group'),
        ...
        $this->setChild('add_group_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('harsheav')->__('Add New'),
        ...
        $this->setChild('reset_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('harsheav')->__('Reset'),
                'onclick'   => 'window.location.reload()'
        )));

        $this->setChild('save_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('harsheav')->__('Save Attribute Set'),
                'onclick'   => 'editSet.save();',
                'class'     => 'save'
        )));

        $deleteConfirmMessage = $this->jsQuoteEscape(Mage::helper('harsheav')
            ->__('All products of this set will be deleted! Are you sure you want to delete this attribute set?'));
        $deleteUrl = $this->getUrl('*/adminhtml_harsheav_set/delete', array('id' => $setId));

        $this->setChild('delete_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('harsheav')->__('Delete Attribute Set'),
        ...
        $this->setChild('rename_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('harsheav')->__('New Set Name'),
    ...
    {
        return Mage::helper('harsheav')->__("Edit Attribute Set '%s'", $this->_getAttributeSet()->getAttributeSetName());
    }

    public function getMoveUrl()
    {
        return $this->getUrl('*/adminhtml_harsheav_set/save', array('id' => $this->_getSetId()));
    }

    public function getGroupUrl()
    {
        return $this->getUrl('*/adminhtml_harsheav_group/save', array('id' => $this->_getSetId()));
    }
    ...
    public function getGroupTreeJson()
    {
        ...
        foreach ($groups as $node) {
            ...
            $nodeChildren = Mage::getResourceModel('harsheav/harsheav_attribute_collection')
    ...
    public function getAttributeTreeJson()
    {
        ...
        $collection = Mage::getResourceModel('harsheav/harsheav_attribute_collection')
            ->setAttributeSetFilter($setId)
            ->load();
        ...
        $attributes = Mage::getResourceModel('harsheav/harsheav_attribute_collection')
        ...
        if (count($items) == 0) {
            $items[] = array(
                'text'      => Mage::helper('harsheav')->__('Empty'),
                'id'        => 'empty',
                'cls'       => 'folder',
                'allowDrop' => false,
                'allowDrag' => false,
